...
if __name__ == '__main__':
    ...
    mice = [Mouse(path='/home/anverdie/share/gaia/Data/Behavior/Antonin/{}'.format(i), tag=['DIS4H'], collab=False, rmgaps='Antonin', verbose=True, linkday=True, gsheet=False) for i in mice_id] 
    all_perfs(mice)
    all_psycho(mice)
